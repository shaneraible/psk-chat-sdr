...
class qpsk_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qpsk = qpsk = digital.constellation_rect([-.7071-.7071j, -.7071+.7071j, .7071+.7071j, .7071-.7071j], [0, 1, 3, 2],
        4, 2, 2, 1, 1).base()
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.qtgui_const_sink_x_0_0, 0))
