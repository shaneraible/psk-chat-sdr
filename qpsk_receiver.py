...
class qpsk_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.output_sps = output_sps = int(sps/2)
        self.nfilts = nfilts = 32
        self.fc = fc = int(433.920e6)
        self.cma_alg = cma_alg = digital.adaptive_algorithm_cma( qpsk, int(100e-6), sps).base()
        self.arity = arity = 4
        ...
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Unpacked Symbol DiffDecoder", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Signal Constellation Decoder", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, rrc_taps, 32, 16, 1.5, output_sps)
        self.digital_map_bb_0 = digital.map_bb([0,1,2,3])
        self.digital_linear_equalizer_0 = digital.linear_equalizer(15, output_sps, cma_alg, True, [ ], 'corr_est')
        self.digital_diff_decoder_bb_0 = digital.diff_decoder_bb(sps, digital.DIFF_DIFFERENTIAL)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(timing_loop_bw, arity, False)
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(qpsk)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(output_sps)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_output_sps(int(self.sps/2))
